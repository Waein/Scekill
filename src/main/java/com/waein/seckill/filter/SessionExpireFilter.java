package com.waein.seckill.filter;
 ...
 *
 * @author Waein :)
 * @version method: SessionExpireFilter, v 0.1 重新设置用户session在redis的有效期
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if (StringUtils.isNotEmpty(loginToken)) {
            ...
            if (user != null) {
                ...
                redisService.expire(UserKey.getByName, loginToken, Constant.RedisCacheExtime.REDIS_SESSION_EXTIME);
            }
        }
